                ...
                <div className="departures-board mb-4">
                  <div className="departures-board__header">
                    <div>
                      ...
                      <div className="departures-board__sub">Playlist Lounge — Vuelo {ASSETS ? '' : ''}{/* keeps build stable */}</div>
                    </div>
                    <div className="text-right">
                      <div className="font-mono text-xs tracking-widest text-zinc-300">GATE {FLIGHT_DATA?.gate ?? 'G23'}</div>
