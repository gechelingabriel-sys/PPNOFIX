              ...
              <div className="animate-slide-in">
                ...
                <div className="departures-board mb-4">
                  ...
                  <div className="px-5 py-4">
                    ...
                    {/* Spotify embed integrado dentro del cartel */}
                    <div className="mb-3 rounded-xl overflow-hidden border border-white/10 bg-black/20">
                      <div className="px-4 py-2 border-b border-white/10 flex items-center justify-between">
                        <div className="text-[10px] uppercase tracking-[0.25em] text-zinc-300">SPOTIFY PREVIEW</div>
                        <div className="text-[10px] font-mono tracking-widest text-amber-200/90">EMBED</div>
                      </div>
                      <div className="h-[300px] sm:h-[352px] max-h-[55vh]">
                        <iframe
