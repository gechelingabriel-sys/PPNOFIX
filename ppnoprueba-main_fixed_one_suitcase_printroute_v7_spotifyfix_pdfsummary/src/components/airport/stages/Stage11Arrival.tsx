    ...
    <div className="min-h-screen pt-20 pb-8 px-4">
      ...
      <div className="print-only hidden">
        <div className="p-10">
          ...
          {/* Resumen */}
          <div className="mb-10">
            <h2 className="text-xl font-bold mb-3">Resumen del viaje</h2>
            <p className="text-sm text-gray-700 leading-relaxed">
              Este fue tu recorrido completo por el "modo aeropuerto": entrada al terminal, check-in, control de seguridad,
              paso por Duty Free, relax en el lounge y un simulacro de vuelo con llegada incluida. Todo termina con el momento
              estrella: abrir el voucher misterioso y desbloquear la maleta con el código.
            </p>

            <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
              {[ 
                'Puertas → acceso autorizado',
                'Check-in → vuelo confirmado',
                'Seguridad → todo en regla',
                'Duty Free → misión cumplida',
                'Lounge → música lista',
                'Llegada → premio desbloqueado',
              ].map((t) => (
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="border rounded-xl p-3">
                <h3 className="font-bold mb-2">Golden Ticket</h3>
                <div className="rounded-xl border border-yellow-300/40 bg-yellow-50 p-4">
                  <div className="text-xs uppercase tracking-widest text-yellow-800">Pipino Air • Acceso VIP</div>
                  <div className="mt-2 text-2xl font-extrabold">GOLDEN TICKET</div>
                  <div className="mt-2 text-sm text-yellow-900">Válido para canjear una sorpresa en destino.</div>
                  <div className="mt-3 text-xs text-yellow-700">Código: {FLIGHT_DATA.flightNumber}-{FLIGHT_DATA.seat}</div>
                </div>
              </div>
              ...
              <div className="border rounded-xl p-3">
                ...
                <div className="rounded-xl border border-gray-200 bg-gradient-to-br from-white to-gray-50 p-4">
                  <div className="text-xs uppercase tracking-widest text-gray-600">Pipino Air • Gift Card</div>
                  <div className="mt-2 text-2xl font-extrabold">PARA COTY</div>
                  <div className="mt-2 text-sm text-gray-700">Usala cuando quieras: hoy, mañana o cuando pinte "modo capricho".</div>
                  <div className="mt-3 text-xs text-gray-500">Emitida: {FLIGHT_DATA.date}</div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-4 grid grid-cols-1 gap-4">
              <div className="border rounded-xl p-3">
                <h3 className="font-bold mb-2">Premio #1 (foto)</h3>
