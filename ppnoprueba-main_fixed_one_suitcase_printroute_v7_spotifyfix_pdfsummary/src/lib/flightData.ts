...
export const ASSETS = {
  ...
  prizes: [
    'https://res.cloudinary.com/dswpi1pb9/image/upload/v1768591556/IMG_5907_qc5mey.jpg'
  ],
  // We no longer show Premio 2 as a clickable link, but we keep the photo for the PDF memory.
  prize2Memory: 'https://res.cloudinary.com/dswpi1pb9/image/upload/v1768569151/premio_2_vjgu6t.jpg',
  dutyFreeProducts: [
    {
      id: 'argentina',
      label: 'Argentina',
